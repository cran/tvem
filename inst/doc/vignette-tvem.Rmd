...
* Li, R., Dziak, J. J., Tan, X., Huang, L., Wagner, A. T., & Yang, J. (2017). TVEM (time-varying effect model) SAS macro users' guide (Version 3.1.1). University Park: The Methodology Center, Penn State. Available online at [https://aimlab.psu.edu/tvem/tvem-sas-macro/])(https://aimlab.psu.edu/tvem/tvem-sas-macro/) and archived at  [https://github.com/dziakj1/MethodologyCenterTVEMmacros](https://github.com/dziakj1/MethodologyCenterTVEMmacros) and [https://scholarsphere.psu.edu/collections/v41687m23q](https://scholarsphere.psu.edu/collections/v41687m23q).
